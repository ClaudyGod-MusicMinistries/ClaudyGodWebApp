...
export const PayPalPayment: React.FC<PayPalPaymentProps> = ({ amount, onNext }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center text-sm text-gray-600">
        ...
        <a href="https://www.paypal.com/signup" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">

...
const BlogWelcome: React.FC = () => {
  return (
    <div className="space-y-6">
      <h2 className="md:text-6xl max-md:text-5xl max-md:text-center font-roboto-condensed
 text-gray-900 tracking-tight">
        Welcome to  <span className="text-purple-700">ClaudyGod Community</span>
      </h2>
      
      <p className="font-work-sans max-md:text-sm md:text-base text-gray-600 leading-relaxed">
      ...
      <div className="space-y-4">
        <div className="flex items-start">
          ...
          <p className="ml-3 max-md:text-xx font-raleway-light
 md:text-sm text-gray-700">
        ...
        <div className="flex items-start">
          ...
          <p className="ml-3 max-md:text-xx md:text-sm font-raleway-light
 text-gray-700">
 ...
 text-gray-700">
  ...
  <button className="mt-6 cursor-pointer font-roboto-condensed md:text-2xl px-6 py-3 bg-purple-700 hover:bg-purple-800 
  text-white font-medium rounded-lg transition duration-300 transform hover:-translate-y-1 block mx-auto md:mx-0">

...
export const products: Product[] = [
  ...
  { id: 2, name: 'Saviour is born, Jesus is here', image: Shop2, price: 5, category: 'clothing', description: 'Mug' },
  { id: 3, name: 'ClaudyGod Premium T-Shirt', image: Shop3, price: 5, category: 'accessories', description: 'T-Shirt' },

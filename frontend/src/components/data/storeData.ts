...
import { Shop1, Shop2, Shop3, Shop4, musicCover1, musicCover2 } from '../../assets';
...
export const products: Product[] = [
  ...
  { id: 5, name: 'ClaudyGod Music EP', image: musicCover1, price: 10, category: 'music', description: 'Digital EP: Pay. Stream. Download.' },
  { id: 6, name: 'Get our Latest Album', image: musicCover2, price: 10, category: 'music', description: 'Full album digital download.' },
];
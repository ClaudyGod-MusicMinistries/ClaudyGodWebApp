...
export const selectActiveCategory = (state: RootState) => state.store.ui.activeCategory;
export const selectCurrentSlide = (state: RootState) => state.store.ui.currentSlide;
export const selectSlideDirection = (state: RootState) => state.store.ui.slideDirection;
export const selectSlideCount = (state: RootState) => state.store.ui.slideCount;
export const selectDialogProduct = (state: RootState) => state.store.ui.dialogProduct;

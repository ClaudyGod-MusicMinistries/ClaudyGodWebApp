  ...
  ClaudyGod: American Contemporary Christian music and Afro-Gospel Songs
          ...
          <div className="flex flex-col md:flex-row gap-4 xs:gap-5 sm:gap-6 md:gap-8 lg:gap-10">
            <div className="md:w-2/3 space-y-3 xs:space-y-4 sm:space-y-5">
              ...
              <p className="text-gray-700 text-[15px] xs:text-base work-sans sm:text-[17px] md:text-lg leading-relaxed md:leading-loose">
          ...
          <div className="md:w-1/3 hidden lg:block aspect-[4/5] xs:aspect-[3/4] md:aspect-[5/6] mt-2 xs:mt-3 sm:mt-0">
  <img 
    src={About2}
    alt="ClaudyGod performing" 
    className="rounded-lg shadow-md w-full h-[80%] object-cover transition-transform duration-300 hover:scale-105"
  />
</div>
          </div>
        </div>

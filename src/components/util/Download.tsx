...
const containerVariants: Variants = {
  ...
  visible: {
    opacity: 1,
    transition: { staggerChildren: 0.1, when: 'beforeChildren', duration: 0.4 },
  },
};
...
export const DownloadSection = () => {
  ...
  // Generate background dots only once to avoid jitter
                ...
                <div className="absolute top-[3%] left-[6%] w-[88%] h-[94%] rounded-[24px] overflow-hidden border-2 border-gray-800">
                  ...
                  <div className="absolute bottom-3 left-3 right-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <SemiBoldText className="text-white text-sm">
                          ClaudyGod
                        </SemiBoldText>
                        <RegularText className="text-purple-300 text-xs">
                          Premium Music
                        </RegularText>
                      </div>
                    </div>
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <LightText
                ...
                fontSize="0.9rem"
              >
                Experience premium music streaming with our mobile app. Download
                now to enjoy your favorite tracks anytime.
              </LightText>
            </motion.div>

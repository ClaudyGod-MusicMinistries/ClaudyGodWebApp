...
// Import images - replace with actual Lagos images
import {
  ph1,
  ph2,
  ph3,
...
const galleryImages = [
  ...
  ph2,
  ph3,
  ph1, // Duplicates for demo - replace with actual Lagos images
  ph2,
  ph3,
  ph1,
  ph2,
...
// Slider images - add your Lagos tour images here
const sliderImages = [
  landing_1, // Replace with actual Lagos images
  landing_2, // Replace with actual Lagos images
];

export const LagosTour: React.FC = () => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        >
          <ExtraBoldText
            style={{
              color: '#ffffff',
              fontSize: 'clamp(1.2rem, 3.5vw, 2.2rem)', // responsive and readable
              lineHeight: '1.2',
            ...
            useThemeColor={false}
          >
            Min. ClaudyGod Lagos Worship Tour
          </ExtraBoldText>
          ...
          <RegularText
            style={{
              color: '#ffffff',
              fontSize: 'clamp(0.85rem, 2.5vw, 1.05rem)', // smaller, consistent with other sections
              lineHeight: '1.6',
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 py-8">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div className="relative h-96 lg:h-[500px] overflow-hidden">
                  <AnimatePresence mode="wait">
                    <motion.img
                      ...
                      alt={`Lagos Worship Experience ${currentSlide + 1}`}
            ...
            >
              ...
              >
                Transforming Lives Through Worship in Lagos
              </ExtraBoldText>
              ...
              >
                The Min. Claudy Music Tour in Lagos was a divine encounter that
              ...
              >
                ...
                revival and transformation. Truly, Lagos witnessed a mighty move
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              ...
              transformation from our Lagos gatherings
            </LightText>
          </div>
        ...
        >
          ...
          >
            Be part of the next worship experience in Lagos. Experience God's
            presence in a unique way that transforms lives.
          </LightText>

    ...
    >
      <div className="text-center mb-6 md:mb-8">
        ...
        >
          ...
          >
            Discover the latest gospel singles now featured on our Gospel News
            page! Stay updated with fresh releases, inspiring messages, and
            uplifting melodies.
          </RegularText>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 w-full">
            <FontAwesomeIcon icon={faSpotify} className="text-sm md:text-lg" />
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 w-full">
            <FontAwesomeIcon icon={faYoutube} className="text-sm md:text-lg" />
        ...
        >
          <div className="flex items-center gap-3 md:gap-4 w-full">
            <FontAwesomeIcon icon={faApple} className="text-sm md:text-lg" />

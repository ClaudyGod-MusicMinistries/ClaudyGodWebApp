    ...
    <div className="mb-6 text-sm">
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4">
        <p className="text-gray-700 mb-3">
          <span className="font-medium">Important:</span> By submitting this
          Request Form, you acknowledge that you will receive emails from the
          ClaudyGod Team.
        </p>
        <ul className="list-disc pl-5 space-y-1 text-gray-600">
          <li>
            This submission is only a request and does not guarantee
            participation
          </li>

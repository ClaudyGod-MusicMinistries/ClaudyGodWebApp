...
import { CheckCircle, Truck, CreditCard, MapPin, User, Mail, Phone } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 py-12">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Order #{order.orderId} Confirmed</h1>
          ...
          <div className="mt-8 flex items-center">
            ...
            <div>
              ...
              {order.paymentInfo.zelleConfirmation && (
                <p className="text-sm">Confirmation: {order.paymentInfo.zelleConfirmation}</p>
              )}
              {order.paymentInfo.paypalTxnId && (
                <p className="text-sm">Transaction ID: {order.paymentInfo.paypalTxnId}</p>
              )}
            </div>
          </div>
        </div>

...
import { faInfoCircle, faPhoneAlt, faEnvelope } from '@fortawesome/free-solid-svg-icons';
...
export const Checkout: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <header className="py-4 shadow-sm" style={{ backgroundColor: colorScheme.gray[100] }}>
          <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center">
                ...
                >
                  <RegularText fontSize="0.75rem" color={colorScheme.text}>1</RegularText>
                </div>
                <RegularText className="ml-2" fontSize="0.875rem" color={colorScheme.primary}>
                  Cart
                </RegularText>
              </div>
              ...
              <div className="flex items-center">
                <div 
                  ...
                  style={{ background: colorScheme.primaryGradient }}
                >
                  <RegularText fontSize="0.75rem" color={colorScheme.text}>2</RegularText>
                </div>
                <RegularText className="ml-2" fontSize="0.875rem" color={colorScheme.primary}>
                  Checkout
                </RegularText>
              ...
              <div className="hidden md:flex items-center">
                <div 
                  ...
                  style={{ backgroundColor: colorScheme.primaryLight }}
                >
                  <RegularText fontSize="0.75rem" color={colorScheme.text}>3</RegularText>
                </div>
                <RegularText className="ml-2" fontSize="0.875rem" color={colorScheme.primary}>
                  Confirmation
                </RegularText>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="p-6" style={{ background: colorScheme.primaryGradient }}>
            ...
            >
              <div className="p-4 rounded-lg border" style={{ 
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1" style={{ color: colorScheme.primary }}>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <BoldText as="h3" fontSize="1.125rem" className="mb-3" color={colorScheme.text}>
                Need Help?
              </BoldText>
              ...
              <div className="flex items-center" style={{ color: colorScheme.primary }}>
                <FontAwesomeIcon icon={faPhoneAlt} className="h-5 w-5 mr-2" />
                <SemiBoldText>+1 (385) 219-6632</SemiBoldText>
              </div>
              <div className="flex items-center mt-2" style={{ color: colorScheme.primary }}>
